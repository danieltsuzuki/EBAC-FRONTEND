...
export const metadata: Metadata = {
    title: "Tsuzuki Tech",
    description: "Desenvolvimento moderno, programação e tecnologia na prática. Conteúdos sobre Next.js, Flutter, Java, arquitetura backend, cloud, dicas de carreira e projetos reais para desenvolvedores que querem evoluir continuamente.",
};
